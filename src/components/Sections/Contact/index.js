...
const ContactValueMap = {
  Email: {Icon: MailIcon, srLabel: 'Email'},
  Phone: {Icon: DeviceMobileIcon, srLabel: 'Phone'},
  Location: {Icon: LocationMarkerIcon, srLabel: 'Location'},
  Github: {Icon: GithubIcon, srLabel: 'Github'},
  LinkedIn: {Icon: LinkedInIcon, srLabel: 'LinkedIn'},
  Facebook: {Icon: FacebookIcon, srLabel: 'Facebook'},
  Twitter: {Icon: TwitterIcon, srLabel: 'Twitter'},
  Instagram: {Icon: InstagramIcon, srLabel: 'Instagram'},
};
